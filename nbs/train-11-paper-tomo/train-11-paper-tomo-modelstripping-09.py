...
from tomo2seg import modular_unet_temp as modular_unet  # !!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
args = train.Args(
    script_name = "train-11-paper-tomo-modelstripping-09.py",
...
model_version = f"f16-stripping-layernorm"
model_type = T2SModelType.d2

model_factory_function = modular_unet.u_net
model_factory_kwargs = {
    'convlayer': modular_unet.ConvLayer.conv2d,
#     'norm_layer': modular_unet.NormLayer.batchnorm,
    'normlayer': modular_unet.NormLayer.layernorm,
    'normtype': modular_unet.NormType.channel,
