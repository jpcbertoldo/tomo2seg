...
args = train.Args(
    script_name = "train-11-paper-tomo_3d.py",
...
# [manual-input]
crop_shape = (32, 32, 32, 1)  # multiple of 16 (requirement of a 4-level u-net)
model_nclasses = 3

model_master_name = "paper-unet-3d"
model_version = f"full-f{f0:02d}"
model_type = T2SModelType.d3
